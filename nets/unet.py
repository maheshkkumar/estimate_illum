...
class Feat2Env(nn.Module):
    ...
    def __init__(self, chromesz: int = 64):
        ...
        self.layers = nn.Sequential(*[nn.Conv2d(512,
                                                (chromesz * chromesz * 3),
                                                1,
                                                padding=0,
                                                bias=True),
    ...
    def forward(self, x, env2feat=None):
        ...
        # env2feat is not None, then we replace the source light features with
        # target features
...
class RelightModel(nn.Module):
    ...
    def forward(self, source_img, target_env):
        ...
        # output of resnet encoder is intermediate features (light and
        # non-light), and skip connections to decoder
        ...
        inter_features, non_light_features, source_light = self.feat_to_env(
            inter_features, target_inter_light_feat)
